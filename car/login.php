...
<!DOCTYPE html>
	<html lang="ja">
	<head>
		<title>自動車運転日報Ｗｅｂシステム（赤木さん） - ログイン</title>
...
function showBack(){
	...
	if (document.querySelector("#loginbtn").value=="パスワード変更"){
		...
		<h2 align="center">自動車運転日報Ｗｅｂシステム（社外用）</h2>
		<h2 style='color:red'></h2>
		<div align="center"><form action="./login_check.php" method="post">
			...
			<div><input type="submit" value="ログイン" name="loginkind" id="loginbtn" ></div>
		</form></div>
		<br>
